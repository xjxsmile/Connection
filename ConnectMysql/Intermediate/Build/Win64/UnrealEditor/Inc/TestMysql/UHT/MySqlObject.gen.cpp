...
#include "../../../TestMysql/Public/MySqlObject.h"
PRAGMA_DISABLE_DEPRECATION_WARNINGS
void EmptyLinkFunctionForGeneratedCodeMySqlObject() {}
// Cross Module References
	COREUOBJECT_API UClass* Z_Construct_UClass_UObject();
	TESTMYSQL_API UClass* Z_Construct_UClass_UMySqlObject();
...
// End Cross Module References
	...
	template<> TESTMYSQL_API UClass* StaticClass<UMySqlObject>()
	{
		return UMySqlObject::StaticClass();
	}
	DEFINE_VTABLE_PTR_HELPER_CTOR(UMySqlObject);
	UMySqlObject::~UMySqlObject() {}
	struct Z_CompiledInDeferFile_FID_SLGPro_Plugins_TestMysql_Source_TestMysql_Public_MySqlObject_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_SLGPro_Plugins_TestMysql_Source_TestMysql_Public_MySqlObject_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMySqlObject, UMySqlObject::StaticClass, TEXT("UMySqlObject"), &Z_Registration_Info_UClass_UMySqlObject, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMySqlObject), 155701261U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_SLGPro_Plugins_TestMysql_Source_TestMysql_Public_MySqlObject_h_3634227916(TEXT("/Script/TestMysql"),
		Z_CompiledInDeferFile_FID_SLGPro_Plugins_TestMysql_Source_TestMysql_Public_MySqlObject_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_SLGPro_Plugins_TestMysql_Source_TestMysql_Public_MySqlObject_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
